...
from swarmpal_mma.utils import configuration as MMA_2E_config
from swarmpal_mma.qmatrix import estimate_SH_coefficients_1D as MMA_2E_estimate_SH_coefficients_1D
from swarmpal_mma.utils.Coord_Trans import get_MagLat as MMA_2E_get_MagLat
